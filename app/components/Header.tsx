...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 bg-dark/80 backdrop-blur-md border-b border-sidebar-border">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        >
          <img
            ...
            loading="eager"
          />
          <span className="text-white font-poppins font-semibold text-lg whitespace-nowrap">
            Kevon Cadogan
          </span>
        </a>
        ...
        <div className="hidden lg:flex items-center gap-2">
          {socials.map((social) => (
            <motion.a
              ...
              className="w-9 h-9 bg-primary rounded-full flex items-center justify-center text-white hover:bg-primary-hover transition-colors"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="lg:hidden border-t border-sidebar-border bg-dark/95 backdrop-blur-md"
