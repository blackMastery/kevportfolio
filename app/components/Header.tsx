...
export default function Header({ isOpen, onClose }: HeaderProps) {
  ...
  const handleNavClick = (href: string, isExternal: boolean = false) => {
    if (isExternal || !href.startsWith('#')) {
      // For external links or non-anchor links (like /blog), navigate normally
      window.location.href = href;
    } else {
      // For anchor links, scroll smoothly if element exists, otherwise navigate home with hash
